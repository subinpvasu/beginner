...
define ('IMGDIR', 'E:\IMAGES\Wallpaper');
// same but for www
define ('WEBIMGDIR', 'Wallpaper/');
...
$(window).bind('load',
    ...
    window.setTimeout(function()
        {
         $.colorbox({opacity:0.3, href:"index.html"});
        }, /*timeout->*//* 2000);
    });
});
	</script>
...
<body>
	<div id="gallery">
        ...
        <p><?=$caption;?></p>
    	<div class="pn">
        	<a href="">First</a> | <a href="" class="sp">Previous</a><a href="">Next</a> | <a href="">Last</a>
        </div>
    </div>
</body>
</html>
