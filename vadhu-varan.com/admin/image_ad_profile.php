...
$result = process_image_upload('ufile');
if ($result === false) {
...
xmlhttp.open("GET","../include/validation.php?msg=truephoto&data="+str+"&auth="+sbn+"&idt="+idt,true);
xmlhttp.send();
}
function showDetail()
{
var z = "'.$id.'";
var asd = "<img src=../upload/"+da+" alt=PHOTO	height=106px width=73px onmousemove=show(\'check"+z+"\') onmouseout=hide(\'check"+z+"\')  > <input type=hidden name=photo-"+z+" value="+da+" />";
this.window.opener.document.getElementById(z).innerHTML=asd;
...
if ($check != 'true') {
	?>
<body>
<form action="image_ad_profile.php" method="post" onsubmit=""
