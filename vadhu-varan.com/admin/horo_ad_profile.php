...
xmlhttp.open("GET","../include/validation.php?msg=truehoro&data="+str+"&auth=true&idt="+idt,true);
xmlhttp.send();
}
function showDetail()
{
var z = "'.$id.'";
var asd = "<img src=../upload/"+da+" alt=Change  height=100px width=100px /><input type=hidden value="+da+" name=photo-imghoro />";
this.window.opener.document.getElementById(z).innerHTML=asd;
this.window.opener.document.getElementById("jathakam").innerHTML="<img src=../upload/"+da+" alt=Change   height=490px width=490px/>";
...
if ($check != 'true') {
	?>
<body>
<form action="horo_ad_profile.php" method="post" onsubmit=""
