...
include_once 'include/topmenu.php';
include_once 'include/functions.php';
update_both($_GET['second'],$_SESSION['who']);
$term = 'visibility:visible';
}


/*
 * check by id and copy to that visited and followed
 * 
 * 
 */
//check session
...
<p>&nbsp;</p>
<div class="frontface" onmouseover="showLinksMail()">
...
<tr>
<td>Name</td>
<td>:<input type="hidden" id="persons" value="<?php	echo $data [0];	?>" /> 
<input type="hidden" id="ciphers" value="<?php echo sha1 ( $data [0] ); ?>" />
<input type="hidden" id="prefunctions" value="0" /><div id="bans"></div></td>
...
<img src="images/girl.png" width="205px" height="242px"  alt="PHOTO" <?php echo "onerror" ?>="personDisplay(<?php echo $pid;?>)" <?php echo "onload" ?>="personDisplay(<?php echo $pid;?>)"/>
...
{
	?>
<img src="images/boy.png" width="205px" height="242px"  alt="PHOTO" <?php echo "onerror" ?>="personDisplay(<?php echo $pid;?>)" <?php echo "onload" ?>="personDisplay(<?php echo $pid;?>)"/>
...
?>
<img src="upload/<?php echo $zata['photos']?>" width="205px" height="242px" alt="PHOTO" <?php echo "onerror" ?>="personDisplay(<?php echo $pid;?>)" <?php echo "onload" ?>="personDisplay(<?php echo $pid;?>)"  />
<?php }
if($zata['profile_image']=='YC'){
?>
<img src="upload/<?php echo $zata['photou']?>" width="205px" height="242px" alt="PHOTO" <?php echo "onerror" ?>="personDisplay(<?php echo $pid;?>)" <?php echo "onload" ?>="personDisplay(<?php echo $pid;?>)"  />
<?php }
if($zata['profile_image']=='YL'){
?>
<img src="upload/<?php echo $zata['photob']?>" width="205px" height="242px" alt="PHOTO" <?php echo "onerror" ?>="personDisplay(<?php echo $pid;?>)" <?php echo "onload" ?>="personDisplay(<?php echo $pid;?>)"  />
<?php }
?>
</a>
<?php 
...
<div class="screen" id="data"></div>

<button class="button" style="position:fixed;top:141px;;height:30px;<?php echo $term;?>" onclick="sendAbuse(<?php echo $pid;?>,<?php echo $_SESSION['who'];?>)">REPORT ABUSE</button>
</div>
<?php }?>
