...
xmlhttp.open("GET","./include/validation.php?msg=display&num="+str,true);
xmlhttp.send();
}
...
function showInform()
{
	...
	xmlhttp.open("GET","./include/validation.php?msg=inform&name="+str,true);
	xmlhttp.send();
	type= 'success'; 
	  var dialog;
	  var dialogheader;
...
function employerApply(sbn,smn)
{
	...
	if(r == true)
	{
		document.getElementById("result").innerHTML="";
					...
					xmlhttp.open("GET","./include/validation.php?msg=empapply&q="+sbn+"&p="+smn,true);
					xmlhttp.send();
