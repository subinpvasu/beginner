...
YOU CAN PROMOTE YOUR PROPERTY USING OUR ADVERTISING PACKAGES <br />
MAKE THE PAYMENT IN ANY OF THE FOLLOWING METHODS <br />
...
<tr><td>Address</td><td>:</td><td> 2nd Floor,  Pooma Complex, M.G.Road,<br> Thrissur - 1.</td>
</tr>
...
</tr><tr><td> Payable at Thrissur, Kerala and send it by Registered Post/Courier<br> or by Hand.</td>
...
<tr>
<td width="565">
<b style="font-size:16px">III.  Direct Cash Deposit at our Office counter or<br>send Money Order</b></td>
</tr><tr><td><b style="color:#339900">
Address:</b> </td>
</tr><tr><td><b style="color:#990033">  M/s. Gitacommunications</b></td>
</tr><tr><td>  T.M.K. Complex,Mannath Lane, </td>
...
</tr><tr><td>visit:<a href="http://infobis.in" style="text-decoration:none">
 www.infobis.in </a>(Classifieds for Global Reach)
...
<td>:</td>
<td>
<input type="text" name="proids" id="pid" class="tb8" disabled  size="30" value="<?php echo $_GET['name'] ?>" maxlength="30" />
<input type="hidden" name="proid" value="<?php echo $_GET['name'] ?>"/>
...
<td>:</td>
<td>
<input type="text" class="tb8" id="tariff" disabled name="tariffs" value="<?php if($_GET['pack'] =='Golden Profile Rs.600'){echo 600;}else if($_GET['pack'] =='Premium Profile Rs.1000'){echo 1000;}?>" size="30" maxlength="30" />
<input type="hidden" name="tariff" value="<?php if($_GET['pack'] =='Golden Profile Rs.600'){echo 600;}else if($_GET['pack'] =='Premium Profile Rs.1000'){echo 1000;}?>"/>
...
<td>:</td>
<td>
<input type="text" class="tb8" id="customer" name="customers" disabled value="<?php echo $name ?>" size="30" maxlength="30" />
...
<td>:</td>
<td>
<input type="text" class="tb8" id="phone" name="phones" disabled value="<?php echo $mobile ?>" size="30" maxlength="30" />
...
<td>:</td>
<td>
<input type="text" class="tb8" id="mail" name="mails" disabled onkeyup="showMail()"  value="<?php echo $mail ?>" size="30" maxlength="30" />
...
<input type="hidden" name="custid" value="<?php echo $_SESSION['id']; ?>" />

<tr>
<td colspan="3" align="center">
<input type="submit" name="adv_order" value="Place My Order" onmouseover="checDate()" class="fb5" />
