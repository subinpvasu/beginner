<?php 
session_start();
if($_SESSION['name'] == '' || $_SESSION['name'] == '  ' || !is_numeric($_SESSION['id']) )
{
...
.twoColFixLtHdr #header { 
	...
	width:30%; /* this padding matches the left alignment of the elements in the divs that appear beneath it. If an image is used in the #header instead of text, you may want to remove the padding. */
} 
...
<div id="container">
  <div id="header">
    <span align="left"><h1>Account</h1></span><span align="right"><?php if(isset($_SESSION['id'])){echo'<a href="logout.php">Log Out</a>';}?></span>
    <!-- end #header --></div>
  <div id="sidebar1">
