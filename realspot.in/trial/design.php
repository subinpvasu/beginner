...
<div id="container">
  ...
  <div id="mainContent">
    <h1> Main Content </h1>
    <input type="text"   class="tb8" size="30">
    <select id="photo"  class="sele" name="cars">
...
function test()
{
var k = document.getElementById("photoxx").alt;
document.getElementById("rest").innerHTML=k; 
}
...
<script type="text/javascript">
document.getElementById("photo").style.background="green";
...
<img src="../images/block.jpg" id="photoxx" value="false"  onclick="test()" alt="" height="15" width="15"/>
...
<table width="40%">
 <tr bgcolor="">
  <td onmouseover="showmenu('tutorials')" onmouseout="hidemenu('tutorials')">
   <a href="/default.asp">Tutorials</a>
